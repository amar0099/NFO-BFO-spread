    ...
    try:
        ...
        for yy, mm, dd, mon in parsed:
            ...
            if is_monthly:
                ...
                code  = f"{yy:02d}{mm}{dd:02d}"  # YYM(no-zero)DD e.g. 26325
...
with tab2:
    ...
    with c_row[1]: custom_interval = st.selectbox("Interval",    [1,3,5,10,15,30,60], index=0, key="c_interval")
...
with tab3:
    ...
    def expiry_to_date(s):
        ...
        # Check if any letter in string → monthly format YYMON e.g. 26MAR
